...
function initializeNavigation() {
                    ...
                    return `
                            <div class="user-profile-container">
                                ...
                                <div class="profile-dropdown-menu">
                                    ...
                                    <a href="${rootPath}profile.html" class="profile-menu-item">
                                        <span>My Profile</span>
                                    </a>
                                    <a href="${rootPath}settings.html" class="profile-menu-item">
                                        <span>Settings</span>
                                    </a>
    ...
    document.addEventListener('click', function (e) {
        if (!e.target.closest('.user-profile-container')) {
            const dropdowns = document.querySelectorAll('.profile-dropdown-menu.active');
